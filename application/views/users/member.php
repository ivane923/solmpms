        ...
        <div class="col-md-12">
            <div class="row">
                <div class="box box-color box-bordered green" style="overflow-x:auto;">
                    ...
                    <table class="table table-hover table-nomargin table-bordered membersTable">
                        <thead>
                            <tr>
                                <th>First Name</th>
                                <th>Last Name</th>
                        ...
                        <tbody>
                            ...
                            <tr rel="<?=@$member['ID'];?>">
                                <td class=""><?=@$member['fname'];?></td>
                                <td class=""><?=@$member['lname'];?></td>
                                <td class="date_created"><?=date('m/d/Y', strtotime(@$member['date_added']));?></td>
                                <td style="width: 95px;">
